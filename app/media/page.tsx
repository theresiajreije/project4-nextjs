                ...
                <div className="mx-auto max-w-[1650px]">
                    <div className="mx-auto mb-16 flex w-full max-w-[820px] overflow-hidden rounded-[14px]">
                        <button
                            ...
                            className={`flex flex-1 cursor-pointer items-center justify-between px-7 py-5 text-left text-[19px] font-semibold leading-7 transition ${activeTab === "reviews"
                        ...
                        <button
                            ...
                            className={`flex flex-1 cursor-pointer items-center justify-between px-7 py-5 text-left text-[19px] font-semibold leading-7 transition ${activeTab === "projects"
                                    ? "bg-[#1bcfcd] text-white"
                                    : "bg-[#07546d] text-white hover:bg-[#0a6380]"
                                }`}
                        >
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex h-[485px] w-full cursor-pointer items-center justify-center">
                                                    <div
                                                        className={`flex w-full max-w-[260px] cursor-pointer flex-col justify-between rounded-[18px] px-6 py-8 transition-all duration-300 ease-out ${isActive
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex h-[560px] w-full cursor-pointer items-center justify-center">
                                                        <div
                                                            className={`relative cursor-pointer overflow-hidden rounded-[20px] transition-all duration-300 ease-out ${isActive
